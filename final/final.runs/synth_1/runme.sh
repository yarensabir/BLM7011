...
HD_PWD='C:/Users/yaren/Documents/GitHub/BLM7011/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log devre.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source devre.tcl
